...
public class ProductsPageLocators {
    public static By productPageSupplierListMenu=By.xpath("//a[@href='//www.made-in-china.com/companysearch.do?subaction=hunt&mode=and&code=0&style=b&isOpenCorrection=1&word=Electronics&comProvice=nolimit']");
